...
const ApprovalAcceptanceForOrganizer = (props: IProps) => {
  ...
  const { mutate, isSuccess, isError, error, isPending } =
    useApprovedAcceptanceForOrganizerMutation((msg) => {
      setErrorMessage(msg);
    });
...
export { ApprovalAcceptanceForOrganizer };
