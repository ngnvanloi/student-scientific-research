...
import { ApprovalAcceptanceForSuperAdmin } from "../ApprovalAcceptance/ApprovalAcceptanceForSuperAdmin";
...
const ModalApprovedAcceptanceForSuperAdmin = (props: IProps) => {
        ...
        <Dialog.Content className="fixed top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] w-full max-w-2xl mx-auto px-4 ">
          <div className="bg-white rounded-md shadow-lg ">
            ...
            <Dialog.Description className="space-y-2 p-4 text-[15.5px] leading-relaxed text-gray-500 h-full">
              <ApprovalAcceptanceForSuperAdmin
...
export { ModalApprovedAcceptanceForSuperAdmin };
