...
const ModalDeleteAccount = (props: IProps) => {
  // STATE
  const { isOpen, setIsOpen, accountID, userName } = props;
    ...
    deleteMutation(accountID, {
      onSuccess: () => {
        toast({
          title: "Thông báo",
          variant: "default",
          description: "Bạn đã xóa tài khoản thành công",
        });
        setIsOpen(false);
      },
      onError: (error) => {
          ...
          <div className="bg-white rounded-md shadow-lg px-4 py-6 sm:flex">
            ...
            <div className="mt-2 text-center sm:ml-4 sm:text-left">
              ...
              <Dialog.Description className="mt-2 text-sm leading-relaxed text-gray-500">
                <p>
                  Bạn có muốn xóa tài khoản <strong>{userName}</strong> không ?
                </p>
                <p>
